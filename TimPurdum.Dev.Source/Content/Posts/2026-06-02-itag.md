...
<a style="font-size: 2rem; font-weight: bold; color: white; text-decoration: none; margin: 0 auto;" href="https://www.geoblazor.com" target="_blank">
    ...
    <img src="/images/layer-list-sample.png" style="height: 1rem" alt="GeoBlazor Map Sample" style="margin-top: 1rem; max-width: 100%; height: auto; border: 2px solid white; border-radius: 10px;" />
